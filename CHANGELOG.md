...
- README section for contributing other Mill heater model information
- HACS and Home Assistant compliance (manifest.json, hacs.json, validation workflows)
...
[1.0.1]: https://github.com/martinwelen/MillLocal/releases/tag/v1.0.1
